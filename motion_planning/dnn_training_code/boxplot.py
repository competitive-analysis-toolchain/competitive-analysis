...
# DNN models
model_paths = ["Iteration_{}/output_NN_training/dnn_model".format(i) for i in range(21)]
#model_paths = ["Iteration_{}/output_NN_training/dnn_model".format(i) for i in range(3)]

# Test sets
test_set_paths = ["Iteration_{}/output_NN_training/test_data_set_iteration{}.csv".format(i, i) for i in range(21)]
#test_set_paths = ["Iteration_{}/output_NN_training/test_data_set_iteration{}.csv".format(i, i) for i in range(3)]
...
for test_set_index, test_set_path in enumerate(test_set_paths):
    ...
    test_features = test_set.iloc[:, 0:3]
    test_labels = test_set.iloc[:, 3:6]
...
# Create a larger figure with adjusted size
