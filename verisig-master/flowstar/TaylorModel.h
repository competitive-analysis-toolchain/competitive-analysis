...
public:
    ...
    Json::Value dump_json(const  std::vector<std::string> & varNames) const;
...
public:
    ...
    */
    Json::Value dump_json(const std::vector<std::string> & stateVarNames, const std::vector<std::string> & tmVarNames) const;
